...
from interactive_city_dashboard.data.populations import df, populations
...
def build_map(selected_city, theme):
    ...
    # Name the base trace
    map_fig.update_traces(marker=dict(size=8, color="blue"), name="Cities")
    ...
    map_fig.update_layout(
        mapbox=dict(center={"lat": city["lat"], "lon": city["lon"]}, zoom=5)
    )
